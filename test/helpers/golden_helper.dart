...
import 'package:movie_app/base/theme/design_system.dart';
import 'package:movie_app/base/theme/movie_app_theme.dart';
  ...
  Themes? theme,
    ...
    pumpDeviceBuilderWithMaterialApp(
      ...
      theme: theme == Themes.light
          ? MovieAppTheme.buildTheme(DesignSystem.light())
          : MovieAppTheme.buildTheme(DesignSystem.dark()),
    );
