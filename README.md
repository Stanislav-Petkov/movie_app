...
```
    ...
    <array>
        ...
        <string>movie_app.example.com</string>
...
Production
```
xcrun simctl openurl booted examplescheme://movie_app.example.com/deepLinks/1
```

UAT
```
xcrun simctl openurl booted exampleuatscheme://movie_appuat.example.com/deepLinks/1
```

SIT
```
xcrun simctl openurl booted examplesitscheme://movie_appsit.example.com/deepLinks/1
```

Development
```
xcrun simctl openurl booted exampledevscheme://movie_appdev.example.com/deepLinks/1
```
